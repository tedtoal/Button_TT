/*
  Button_TT.h - Library for displaying a labelled button on a pixel device.
  ...
  is now partly in the base class Button_TT_Base and partly in its derived
  class defined here, Button_TT.
  ...
  Class Button_TT is derived from the base button class Button_TT_Base, and adds
  a string label that is displayed in the button boundary. Additional button
  functionality can be added by deriving from this class.
*/
#ifndef Button_TT_h
#define Button_TT_h
...
class Button_TT : public Button_TT_Base {
