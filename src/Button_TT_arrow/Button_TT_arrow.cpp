/*
  Button_TT_arrow.cpp - Library for displaying a triangular button.
...
void Button_TT_arrow::initButton(Adafruit_GFX *gfx,
  ...
  Button_TT_Base::initButton(gfx, xL, yT, w, h, outlineColor, fillColor,
    expU, expD, expL, expR);
