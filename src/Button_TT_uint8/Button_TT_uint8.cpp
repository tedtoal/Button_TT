/*
  Button_TT_uint8.cpp - Library for adding a variable of type uint8_t to a button.
...
void Button_TT_uint8::initButton(Adafruit_GFX *gfx, const char* align,
                  ...
                  uint8_t (*checkValue)(Button_TT_uint8& btn, uint8_t value),
...
bool Button_TT_uint8::valueIncDec(int8_t N, Button_TT_Base* btn) {
