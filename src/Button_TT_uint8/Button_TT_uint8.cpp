/*
  Button_TT_uint8.cpp - Library for adding a variable of type uint8_t to a
...
void Button_TT_uint8::initButton(
    ...
    const GFXfont *f, int16_t rCorner, uint8_t value, uint8_t minValue,
    uint8_t maxValue, const char *zeroString, bool degreeSym,
