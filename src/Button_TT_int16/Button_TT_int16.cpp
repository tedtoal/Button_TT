/*
  Button_TT_int16.cpp - Library for adding a variable of type int16_t to a
...
void Button_TT_int16::initButton(
    ...
    const GFXfont *f, int16_t rCorner, int16_t value, int16_t minValue,
    int16_t maxValue, bool degreeSym, bool showPlus,
