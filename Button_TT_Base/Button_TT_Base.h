/*
  Button_TT_Base.h - Library for displaying a button on a pixel device, and
  provides a base class from which more sophisticated button classes can be
  derived.
  ...
  classes can be derived) and class Button_TT, which fixes the centering
  problem and adds other features.

  Class Button_TT_Base maintains size, position, and press-state information for
  a button object displayed on a pixel device, and is a base class from which to
  derive other button classes.
*/
