/*
  Button_TT_uint16.cpp - Library for adding a variable of type int16_t to a button.
...
void Button_TT_uint16::initButton(Adafruit_GFX *gfx, const char* align,
                  ...
                  uint16_t (*checkValue)(Button_TT_uint16& btn, uint16_t value),
...
bool Button_TT_uint16::setValueAndDrawIfChanged(uint16_t value, bool forceDraw) {
  setValue(value);
